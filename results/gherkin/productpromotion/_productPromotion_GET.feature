...
Scenario: TMF637 Product Inventory Management - resource /productPromotion for response code 200 OK
  ...
  And each ProductPromotion object should have the optional properties: agreement, appliedBy, appliedReason, benefitProduct, contractCategory, extensions, href, id, immediatePromotionId, instanceManagementType, lastUpdate, metadata, previousPromotionId, productPromotionCharacteristics, productPromotionRelationship, promotion, promotionProtection, promotionRelatedParty, relatedParty, revokeReason, revokedBy, startDate, state, status, triggerProduct
