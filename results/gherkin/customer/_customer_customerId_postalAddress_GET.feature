...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/postalAddress for response code 200 OK
  ...
  And if extensions is present, it should have the properties: streetName, streetNumber, verificationStatus, additionalNumber, additional1, additional2, geographicAddressType