...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/postalAddress for response code 200 OK
  ...
  And if place is present, it should contain the optional properties: @referredType, @type, id, subPlace
  And if subPlace is present, it should contain the optional properties: @referredType, @type, id