...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/preference for response code 200 OK
    ...
    And if partyPrivacyProfilePreference is absent and the user doesn't have the "D1_PrivacyManagement_retrievePartyPrivacyProfiles" role, a message should be included in the response