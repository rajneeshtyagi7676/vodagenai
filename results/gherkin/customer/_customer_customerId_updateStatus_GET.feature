...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/updateStatus for response code 200 OK
    ...
    And the Customer object should have the optional properties: name, description, customerType, customerSubType, engagedParty, account, characteristic, contactMedium, creditProfile, agreement, relatedParty, validFor, paymentMethod, statusDate, statusReason, rank, href, createdOn, lastModifiedOn, acquisitionDate, extensions, externalIdentifier
