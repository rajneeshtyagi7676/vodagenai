...
Scenario: TMF629 Customer Management - resource /customer/{customerId} for response code 200 OK
  ...
  And the Customer object should have the optional properties: customerType, customerSubType, description, engagedParty, account, characteristic, contactMedium, creditProfile, agreement, relatedParty, validFor, paymentMethod, statusDate, statusReason, rank, acquisitionDate, createdOn, lastModifiedOn, extensions
