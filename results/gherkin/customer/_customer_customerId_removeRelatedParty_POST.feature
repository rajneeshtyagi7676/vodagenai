...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/removeRelatedParty for response code 200 OK
    ...
    And the Customer object should have the optional properties: name, description, customerType, customerSubType, engagedParty, relatedParty, characteristic, contactMedium, account, paymentMethod, creditProfile, agreement, validFor, statusDate, statusReason, createdOn, lastModifiedOn, rank, acquisitionDate, @baseType, @schemaLocation, @type, extensions
