...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/relatedIndividual for response code 200 OK
  ...
  And the response should include individual information with their roles in customer, financial account, billing account, and payment method entities based on the includeFrom parameter