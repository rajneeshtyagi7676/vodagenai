...
Scenario: TMF629 Customer Management - resource /customer for response code 200 OK
  ...
  And each Customer object should have the optional properties: account, characteristic, contactMedium, creditProfile, customerSubType, customerType, description, engagedParty, href, paymentMethod, rank, relatedParty, statusDate, statusReason, validFor
