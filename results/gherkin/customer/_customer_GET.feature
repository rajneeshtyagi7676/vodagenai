...
Scenario: TMF629 Customer Management - resource /customer for response code 200 OK
  ...
  And each Customer object should have the properties: id, href, name, status, statusReason, statusDate, validFor, characteristic, engagedParty, relatedParty, account, paymentMethod, creditProfile, contactMedium
