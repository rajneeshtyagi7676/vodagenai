...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/addPostalAddress for response code 200 OK
  ...
  And the Customer object should have the optional properties: customerType, customerSubType, description, engagedParty, account, contactMedium, characteristic, creditProfile, agreement, relatedParty, validFor, paymentMethod, statusDate, statusReason, createdOn, lastModifiedOn, rank, acquisitionDate, extensions
