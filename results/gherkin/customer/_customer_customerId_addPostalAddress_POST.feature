...
Scenario: TMF629 Customer Management - resource /customer/{customerId}/addPostalAddress for response code 200 OK
    ...
    And the Customer object should have the optional properties: customerType, customerSubType, description, engagedParty, contactMedium, characteristic, account, relatedParty, validFor, statusDate, statusReason, paymentMethod, agreement, createdOn, lastModifiedOn, rank, extensions, externalIdentifier
    And the Customer object contactMedium should contain the newly added postal address