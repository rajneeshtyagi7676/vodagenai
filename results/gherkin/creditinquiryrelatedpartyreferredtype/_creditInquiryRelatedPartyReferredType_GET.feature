...
Scenario: TMF629 Customer Management - resource /creditInquiryRelatedPartyReferredType for response code 200 OK
    ...
    And each CreditInquiryRelatedPartyReferredType object should have the required properties: @type
    And each CreditInquiryRelatedPartyReferredType object should have the optional properties: creditInquiryRelatedPartyReferredType, creditInquiryRelatedPartyReferredTypeRole, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
