Feature: TMF629 Customer Management - resource /creditProfileRelatedPartyReferredType/{creditProfileRelatedPartyReferredType}/creditProfileRelatedPartyReferredTypeRole for response code 200 OK

Scenario: TMF629 Customer Management - resource /creditProfileRelatedPartyReferredType/{creditProfileRelatedPartyReferredType}/creditProfileRelatedPartyReferredTypeRole for response code 200 OK
  Given with the server api.test.asgw.sol-vf.de for api /customerManagement/v1 and the resource /creditProfileRelatedPartyReferredType/{creditProfileRelatedPartyReferredType}/creditProfileRelatedPartyReferredTypeRole
  ...
  And each CreditProfileRelatedPartyReferredTypeRole object should have the optional properties: href, shortLabelDisplay, fullLabelDisplay, selectionDisplay, active, default, @type, extensions
