...
Scenario: TMF629 Customer Management - resource /creditRatingCharacteristicName for response code 200 OK
  ...
  And each CreditRatingCharacteristicName object should have the optional properties: href, shortLabelDisplay, fullLabelDisplay, selectionDisplay, active, default, @type
