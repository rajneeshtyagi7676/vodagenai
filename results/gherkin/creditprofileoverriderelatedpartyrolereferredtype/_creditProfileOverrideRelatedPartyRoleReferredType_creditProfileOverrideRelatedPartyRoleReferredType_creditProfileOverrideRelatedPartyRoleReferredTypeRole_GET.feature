...
Scenario: TMF629 Customer Management - resource /creditProfileOverrideRelatedPartyRoleReferredType/{creditProfileOverrideRelatedPartyRoleReferredType}/creditProfileOverrideRelatedPartyRoleReferredTypeRole for response code 200 OK
  ...
  And each CreditProfileOverrideRelatedPartyRoleReferredTypeRole object should have the required properties: @type
  And each CreditProfileOverrideRelatedPartyRoleReferredTypeRole object should have the optional properties: creditProfileOverrideRelatedPartyRoleReferredType, creditProfileOverrideRelatedPartyRoleReferredTypeRole, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
