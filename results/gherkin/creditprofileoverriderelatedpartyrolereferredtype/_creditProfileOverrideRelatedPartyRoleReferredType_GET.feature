...
Scenario: TMF629 Customer Management - resource /creditProfileOverrideRelatedPartyRoleReferredType for response code 200 OK
  ...
  And each CreditProfileOverrideRelatedPartyRoleReferredType object should have the required properties: @type
  And each CreditProfileOverrideRelatedPartyRoleReferredType object should have the optional properties: creditProfileOverrideRelatedPartyRoleReferredType, creditProfileOverrideRelatedPartyRoleReferredTypeRole, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
