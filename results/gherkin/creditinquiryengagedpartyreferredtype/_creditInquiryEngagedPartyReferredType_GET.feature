...
Scenario: TMF629 Customer Management - resource /creditInquiryEngagedPartyReferredType for response code 200 OK
  ...
  And each CreditInquiryEngagedPartyReferredType object should inherit properties from ReferenceData: href, shortLabelDisplay, fullLabelDisplay, selectionDisplay, active, default, @type
