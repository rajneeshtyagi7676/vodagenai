...
Scenario: TMF629 Customer Management - resource /creditProfileStatus for response code 200 OK
  ...
  And each CreditProfileStatus object should have the optional properties: @type, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay, creditProfileStatus, extensions, transitionToStatus
