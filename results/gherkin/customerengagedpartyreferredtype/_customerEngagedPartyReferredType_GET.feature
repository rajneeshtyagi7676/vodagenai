...
Scenario: TMF629 Customer Management - resource /customerEngagedPartyReferredType for response code 200 OK
  ...
  And each CustomerEngagedPartyReferredType object should have the optional properties: customerEngagedPartyReferredType, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay