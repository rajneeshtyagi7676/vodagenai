...
Scenario: TMF629 Customer Management - resource /creditProfileRelatedPartyRoleReferredType/{creditProfileRelatedPartyRoleReferredType}/creditProfileRelatedPartyRoleReferredTypeRole for response code 200 OK
  ...
  And each CreditProfileRelatedPartyRoleReferredTypeRole object should have the required properties: @type
  And each CreditProfileRelatedPartyRoleReferredTypeRole object should have the optional properties: creditProfileRelatedPartyRoleReferredType, creditProfileRelatedPartyRoleReferredTypeRole, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
