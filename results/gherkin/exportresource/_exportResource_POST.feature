...
Scenario: TMF637 Product Inventory Management - resource /exportResource for response code 200 OK
  ...
  And the jobDefinitionId property should contain [RESPONSE-jobDefinitionId-PLACEHOLDER]
  And the jobInstanceId property should contain [RESPONSE-jobInstanceId-PLACEHOLDER]