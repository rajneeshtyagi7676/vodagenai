...
Scenario: TMF629 Customer Management - resource /creditRatingAgencyType for response code 200 OK
  ...
  And each CreditRatingAgencyType object should have the required properties: @type
  And each CreditRatingAgencyType object should have the optional properties: creditRatingAgencyType, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
