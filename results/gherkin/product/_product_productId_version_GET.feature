...
Scenario: TMF637 Product Inventory Management - resource /product/{productId}/version for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, productOffering, productSpecification, productCharacteristic, productOfferingCharacteristic, productPrice, productTotalPrice, billingAccount, relatedParty, place, productRelationship, product, status, startDate, orderDate, terminationDate, activationDate, version, statusChangeReason, primaryProductId, rootProductId, parentId, pathToRoot, productSerialNumber, quantity, productTerm, businessActivity, message, metadata, extensions, lastUpdate, previousStatus, previousStatusChangeReason, creationDate, externalIdentifier, highVolumeProductPromotion, productOrderItem, productPricePerUnit, note, nextAction, attachment, agreement, channel, contractCategory, rootProductOfferingId, versionObsolete