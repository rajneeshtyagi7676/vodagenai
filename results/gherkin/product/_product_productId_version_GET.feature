...
Scenario: TMF637 Product Inventory Management - resource /product/{productId}/version for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, productOffering, productSpecification, productCharacteristic, productOfferingCharacteristic, status, startDate, terminationDate, orderDate, activationDate, lastUpdate, version, productPrice, productTotalPrice, billingAccount, relatedParty, place, productRelationship, product, rootProductId, primaryProductId, parentId, pathToRoot, productSerialNumber, statusChangeReason, previousStatus, previousStatusChangeReason, productTerm, businessActivity, productOrderItem, attachment, agreement, channel, note, metadata, nextAction, externalIdentifier, highVolumeProductPromotion, contractCategory, creationDate, message, versionObsolete, extensions, @baseType, @type