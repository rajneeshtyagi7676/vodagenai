...
Scenario: TMF637 Product Inventory Management - resource /product/{productId}/version for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, status, version, startDate, terminationDate, orderDate, activationDate, lastUpdate, productOffering, productSpecification, billingAccount, relatedParty, productCharacteristic, productOfferingCharacteristic, productPrice, productTotalPrice, productRelationship, place, productPromotion, productTerm, statusChangeReason, message, metadata, extensions, creationDate, previousStatus, previousStatusChangeReason, productOrderItem, attachment, agreement, channel, externalIdentifier, highVolumeProductPromotion, note, nextAction, contractCategory, versionObsolete, rootProductOfferingId, pathToRoot, parentId, rootProductId, primaryProductId, productSerialNumber, quantity