...
Scenario: TMF637 Product Inventory Management - resource /product/{productId}/version for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, productOffering, productSpecification, productCharacteristic, productOfferingCharacteristic, status, startDate, terminationDate, orderDate, activationDate, lastUpdate, version, productPrice, productTotalPrice, billingAccount, relatedParty, place, productRelationship, product, productPromotion, rootProductId, primaryProductId, parentId, pathToRoot, productSerialNumber, statusChangeReason, previousStatus, previousStatusChangeReason, quantity, businessActivity, metadata, message, creationDate, externalIdentifier, highVolumeProductPromotion, note, nextAction, channel, agreement, attachment, productOrderItem, productPricePerUnit, contractCategory, versionObsolete, rootProductOfferingId, statusChangeDate, @baseType, @type