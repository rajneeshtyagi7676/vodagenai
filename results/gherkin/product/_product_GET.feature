...
Scenario: TMF637 Product Inventory Management - resource /product for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, productSerialNumber, startDate, terminationDate, status, activationDate, orderDate, lastUpdate, creationDate, version, versionObsolete, pathToRoot, parentId, rootProductId, primaryProductId, previousStatus, statusChangeDate, contractCategory
