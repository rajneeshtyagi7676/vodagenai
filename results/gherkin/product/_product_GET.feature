...
Scenario: TMF637 Product Inventory Management - resource /product for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, productSerialNumber, startDate, terminationDate, status, version, lastUpdate, creationDate, billingAccount, productOffering, productSpecification, productCharacteristic, productOfferingCharacteristic, productPrice, productTotalPrice, productPricePerUnit, productRelationship, relatedParty, place, productTerm, agreement, attachment, channel, productOrderItem, productPromotion, rootProductId, primaryProductId, parentId, pathToRoot, activationDate, orderDate, statusChangeDate, previousStatus, previousStatusChangeReason, statusChangeReason, nextAction, note, metadata, externalIdentifier, highVolumeProductPromotion, contractCategory, message, quantity, versionObsolete, rootProductOfferingId
