...
Scenario: TMF637 Product Inventory Management - resource /product for response code 200 OK
  ...
  And each Product object should have the optional properties: id, href, name, description, isBundle, isCustomerVisible, orderDate, startDate, terminationDate, status, statusChangeReason, version, lastUpdate, creationDate, billingAccount, productOffering, productSpecification, productCharacteristic, productOfferingCharacteristic, productPrice, productTotalPrice, productPricePerUnit, productRelationship, relatedParty, productTerm, place, productPromotion, productSerialNumber, attachment, agreement, channel, rootProductId, primaryProductId, parentId, pathToRoot, quantity, activationDate, metadata, externalIdentifier, highVolumeProductPromotion, message, nextAction, note, previousStatus, previousStatusChangeReason, productOrderItem, contractCategory, statusChangeDate, versionObsolete, rootProductOfferingId
