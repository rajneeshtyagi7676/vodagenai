...
Scenario: TMF629 Customer Management - resource /accountReferredType for response code 200 OK
  ...
  And each AccountReferredType object should have the required properties: @type
  And each AccountReferredType object should have the optional properties: accountReferredType, extensions
