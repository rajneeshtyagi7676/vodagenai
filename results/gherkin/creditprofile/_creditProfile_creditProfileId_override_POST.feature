...
Scenario: TMF629 Customer Management - resource /creditProfile/{creditProfileId}/override for response code 200 OK
  ...
  And each creditRating object should have the optional properties: characteristic, creditRiskRating, extensions, id, primary, ratingAgencyName, ratingAgencyType, ratingReference, ratingScore, validFor
  And each characteristic object should have the optional properties: category, id, name, overridden, value, valueType