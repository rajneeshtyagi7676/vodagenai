...
Scenario: TMF629 Customer Management - resource /creditProfile/{creditProfileId}/override for response code 200 OK
  ...
  And the CreditProfile object should have the optional properties: characteristic, creditProfileDate, creditRating, creditRiskRating, creditScore, extensions, externalIdentifier, href, lastUpdate, partyPrivacyProfile, relatedCreditParty, relatedParty, relatedPartyRole, status, validFor