...
Scenario: TMF629 Customer Management - resource /creditProfile/{creditProfileId}/updatePartyPrivacyProfile for response code 200 OK
  ...
  And the CreditProfile object should have the optional properties: creditProfileDate, creditRiskRating, creditScore, externalIdentifier, href, lastUpdate, partyPrivacyProfile, relatedCreditParty, relatedParty, relatedPartyRole, status, validFor, characteristic, creditRating