...
Scenario: TMF629 Customer Management - resource /creditProfile for response code 200 OK
  ...
  And each CreditProfile.characteristic should be an array of CreditProfileCharacteristic objects
  And each CreditProfile.creditRating should be an array of PartyCreditRating objects
  And each CreditProfile.externalIdentifier should be an array of ExternalIdentifier objects
  And each CreditProfile.relatedParty should be an array of RelatedPartyRef objects