...
Scenario: TMF629 Customer Management - resource /creditProfile for response code 200 OK
  ...
  And the CreditProfile characteristic array should contain CreditProfileCharacteristic objects with properties: id, name, value, valueType, category, overridden
  And the CreditProfile creditRating array should contain PartyCreditRating objects with properties: id, ratingScore, creditRiskRating, ratingAgencyName, ratingAgencyType, ratingReference, primary, validFor, characteristic, extensions