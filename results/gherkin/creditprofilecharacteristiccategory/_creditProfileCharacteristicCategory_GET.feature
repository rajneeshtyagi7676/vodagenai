...
Scenario: TMF629 Customer Management - resource /creditProfileCharacteristicCategory for response code 200 OK
  ...
  And each CreditProfileCharacteristicCategory object should have the required properties: @type
  And each CreditProfileCharacteristicCategory object should have the optional properties: active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay, creditProfileCharacteristicCategory, extensions
