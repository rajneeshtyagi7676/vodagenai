...
Scenario: TMF629 Customer Management - resource /customerType for response code 200 OK
  ...
  And each CustomerType object should have the required properties: @type
  And each CustomerType object should have the optional properties: customerType, customerSubType, engagedParty, extensions, active, default, fullLabelDisplay, href, selectionDisplay, shortLabelDisplay
