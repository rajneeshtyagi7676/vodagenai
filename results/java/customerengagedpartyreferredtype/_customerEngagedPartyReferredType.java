...
/**
 * Generated API tests for Customerengagedpartyreferredtype GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T09:29:36.377296
 */
public class CustomerengagedpartyreferredtypeGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customerEngagedPartyReferredTypeforresponsecode200OK() {
        given()
            ...
            .queryParam("customerEngagedPartyReferredType", "test_value")
        .when()
            .get("/customerEngagedPartyReferredType")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
