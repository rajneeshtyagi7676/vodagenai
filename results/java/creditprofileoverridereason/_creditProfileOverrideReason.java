...
/**
 * Generated API tests for Creditprofileoverridereason GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:38:42.483470
 */
public class CreditprofileoverridereasonGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditProfileOverrideReasonforresponsecode200OK() {
        given()
            ...
            .queryParam("creditProfileOverrideReason", "test_value")
        .when()
            .get("/creditProfileOverrideReason")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
