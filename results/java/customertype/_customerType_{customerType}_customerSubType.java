...
/**
 * Generated API tests for Customersubtype GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-10-07T10:04:51.505527
 */
public class CustomersubtypeGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customerType/{customerType}/customerSubTypeforresponsecode200OK() {
        given()
            ...
            .queryParam("customerSubType", "test_value")
        .when()
            .get("/customerType/{customerType}/customerSubType")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
