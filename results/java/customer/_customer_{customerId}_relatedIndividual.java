...
/**
 * Generated API tests for Relatedindividual GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T08:31:30.999715
 */
public class RelatedindividualGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customer/{customerId}/relatedIndividualforresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("salesChannel", "test_value")
            .queryParam("includeFrom", "test_value")
        .when()
            .get("/customer/{customerId}/relatedIndividual")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
