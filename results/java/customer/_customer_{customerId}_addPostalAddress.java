 ...
 * Generated at: 2025-08-08T08:57:44.590323
 */
public class AddpostaladdressGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customer/{customerId}/addPostalAddressforresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("salesChannel", "test_value")
        .when()
            .get("/customer/{customerId}/addPostalAddress")
        .then()
            .statusCode(200)
            .body("$", isA(Map.class))
