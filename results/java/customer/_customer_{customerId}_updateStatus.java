...
/**
 * Generated API tests for Updatestatus GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-12T08:54:40.543731
 */
public class UpdatestatusGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customer/{customerId}/updateStatusforresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("salesChannel", "test_value")
        .when()
            .get("/customer/{customerId}/updateStatus")
        .then()
            .statusCode(200)
            .body("$", isA(Map.class))
