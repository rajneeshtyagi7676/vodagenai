...
/**
 * Generated API tests for Customerpaymentmethodtype GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:36:55.188882
 */
public class CustomerpaymentmethodtypeGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/customerPaymentMethodTypeforresponsecode200OK() {
        given()
            ...
            .queryParam("customerPaymentMethodType", "test_value")
        .when()
            .get("/customerPaymentMethodType")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
