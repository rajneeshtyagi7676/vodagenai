...
/**
 * Generated API tests for Creditinquiryrelatedpartyreferredtype GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-12T07:50:26.187893
 */
public class CreditinquiryrelatedpartyreferredtypeGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditInquiryRelatedPartyReferredTypeforresponsecode200OK() {
        given()
            ...
            .queryParam("creditInquiryRelatedPartyReferredType", "test_value")
        .when()
            .get("/creditInquiryRelatedPartyReferredType")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
