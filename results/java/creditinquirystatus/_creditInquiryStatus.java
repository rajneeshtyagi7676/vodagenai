...
/**
 * Generated API tests for Creditinquirystatus GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:37:17.881506
 */
public class CreditinquirystatusGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditInquiryStatusforresponsecode200OK() {
        given()
            ...
            .queryParam("creditInquiryStatus", "test_value")
        .when()
            .get("/creditInquiryStatus")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
