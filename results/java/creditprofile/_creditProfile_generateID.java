 ...
 * Generated at: 2025-08-08T08:36:26.779264
 */
public class GenerateidGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditProfile/generateIDforresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("salesChannel", "test_value")
            .queryParam("limit", "test_value")
        .when()
            .get("/creditProfile/generateID")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
