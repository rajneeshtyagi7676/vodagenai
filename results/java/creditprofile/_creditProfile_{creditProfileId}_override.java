 ...
 * Generated at: 2025-08-12T07:50:19.726776
 */
public class OverrideGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditProfile/{creditProfileId}/overrideforresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("salesChannel", "test_value")
        .when()
            .get("/creditProfile/{creditProfileId}/override")
        .then()
            .statusCode(200)
            .body("$", isA(Map.class))
