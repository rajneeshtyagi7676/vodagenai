 ...
 * Generated at: 2025-08-12T08:54:48.523880
 */
public class CreditratingagencynameGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditRatingAgencyNameforresponsecode200OK() {
        given()
            ...
            .queryParam("creditRatingAgencyName", "test_value")
        .when()
            .get("/creditRatingAgencyName")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
