...
/**
 * Generated API tests for {listname} GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:36:59.004403
 */
public class {listname}GETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/referenceDataList/{listName}forresponsecode200OK() {
        given()
            .contentType(ContentType.JSON)
            .queryParam("context", "test_value")
        ...
        .when()
            .get("/referenceDataList/{listName}")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
