...
/**
 * Generated API tests for Creditprofilestatus GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-10-07T10:04:58.859307
 */
public class CreditprofilestatusGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditProfileStatusforresponsecode200OK() {
        given()
            ...
            .queryParam("creditProfileStatus", "test_value")
        .when()
            .get("/creditProfileStatus")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
