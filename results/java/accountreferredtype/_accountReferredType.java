...
/**
 * Generated API tests for Accountreferredtype GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:36:57.112348
 */
public class AccountreferredtypeGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/accountReferredTypeforresponsecode200OK() {
        given()
            ...
            .queryParam("accountReferredType", "test_value")
        .when()
            .get("/accountReferredType")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
