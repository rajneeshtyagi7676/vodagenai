...
/**
 * Generated API tests for Creditprofilecharacteristiccategory GET endpoint
 * Based on Gherkin scenarios
 * Generated at: 2025-08-08T17:36:44.547284
 */
public class CreditprofilecharacteristiccategoryGETTest {
    ...
    @Test
    public void TMF629CustomerManagementresource/creditProfileCharacteristicCategoryforresponsecode200OK() {
        given()
            ...
            .queryParam("creditProfileCharacteristicCategory", "test_value")
        .when()
            .get("/creditProfileCharacteristicCategory")
        .then()
            .statusCode(200)
            .body("$", isA(List.class))
